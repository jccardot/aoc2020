...
iPrevJolts = 0.
FOR EACH ttAdapter:
    IF ttAdapter.iJolts - iPrevJolts = 1 THEN
        iOne = iOne + 1.
    ELSE IF ttAdapter.iJolts - iPrevJolts = 3 THEN
        iThree = iThree + 1.
    ELSE MESSAGE "invalid gap @ " ttAdapter.iJolts "(previous:" iPrevJolts ")"
        VIEW-AS ALERT-BOX INFO BUTTONS OK.
    iPrevJolts = ttAdapter.iJolts.
END.

MESSAGE ETIME SKIP iOne * iThree
    VIEW-AS ALERT-BOX INFO BUTTONS OK.
